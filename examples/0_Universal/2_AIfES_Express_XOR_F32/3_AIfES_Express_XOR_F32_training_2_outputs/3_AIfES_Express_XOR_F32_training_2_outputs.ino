 /*
  ...
  AIfES-Express XOR training 2 outputs demo
  --------------------
  ...
  This example corresponds to "2_AIfES-Express_XOR_training" but here two outputs are used. This XOR gate is of course fictive.
  ...
  For the training the SGD Optimizer is used. 
...
void setup() {
  ...
  Serial.println(F("AIfES-Express XOR training 2 outputs demo"));
    ...
    if(str.indexOf("training") > -1)       //Keyword "training"
     {
        ...
        */
        ...
        float output_data[DATASETS][2];                                                     // Output data
        ...
        */
        ...
        FNN_TRAIN.optimizer = AIfES_E_sgd;
        /* optimizers
            AIfES_E_adam
            AIfES_E_sgd
        */
        ...
        */
        FNN_TRAIN.learn_rate = 0.3f;                            // Learning rate is for all optimizers
        FNN_TRAIN.sgd_momentum = 0.1f;                          // Only interesting for SGD
        ...
        */
        ...
        Serial.println(F("SGD optimizer:"));
