 /*
  ...
  ATTENTION!!!
  Arduino_CMSIS-DSP library is necessary. It needs to be installed via the library manager. It includes the arm_math.h for AIfES on ARM CPUs.
  ...
  The activation of CMSIS in AIfES is a bit more complicated, because you need to remove the comment before the define "AIFES_WITH_CMSIS" in the "aifes.h"
  - search for the "aifes.h" file in your Arduino IDE in the libraries folder
  - remove the comments before #define AIFES_WITH_CMSIS
  - save your changes
    ...
    if(str.indexOf("training") > -1)       //Keyword "training"
     {
        ...
        */
        ...
        ailayer_dense_t dense_layer_2;                  // Creation of the AIfES hidden dense layer 2
