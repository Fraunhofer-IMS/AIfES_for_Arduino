...
/**
 * \file basic/base/ailayer/ailayer_softsign.h
 * \internal
 * \date 16.03.2021
 * \endinternal
 * \version 2.2.0
 ...
 *
 * \brief Base \link ailayer layer \endlink implementation of the Softsign activation layer
 *
 * This is an "abstract" data-type independent implementation. To use the layer use one of the provided
 * implementations for a specific hardware and data-type (for example from ailayer_softsign_default.h) or set
 * the required math functions on your own.
 *
 * \image html ailayer_softsign_schematic.png width=200px
 *
...
#ifndef SOFTSIGN_LAYER
#define SOFTSIGN_LAYER

#include "core/aifes_core.h"

typedef struct ailayer_softsign 	ailayer_softsign_t;

/** @brief General \link ailayer_softsign.h Softsign layer \endlink struct
*
*/
struct ailayer_softsign {
	...
	/** @brief Required math function: Softsign
	 *
	...
	/** @brief Required math function: Derivative of softsign
	 *
 ...
 */
extern const aicore_layertype_t *ailayer_softsign_type;

/** @brief Initialize and connect the given Softsign layer
 *
 * This function represents the "constructor" of the abstract Softsign layer. It initializes the layer structure
 ...
 * (like for example ailayer_softsign_f32_default()).
 *
 * @param *layer        The layer to initialize.
 * @param *input_layer  The previous layer that provides the inputs to the layer.
 * @return  Pointer to the (successfully) initialized general layer structure (ailayer_softsign.base).
 */
 ...
 * Used math functions:
 * * ailayer_softsign.softsign
 * * ailayer_softsign.d_softsign
 * * ailayer_softsign.multiply
 *
