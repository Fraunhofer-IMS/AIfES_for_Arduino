/**
 * \file basic/avr_pgm/ailayer/ailayer_tanh_avr_pgm.h
 * \internal
 * \date 23.11.2021
 * \endinternal
 * \version 2.2.0
 ...
 *
 * \brief AVR PGM implementation of the \link ailayer_tanh.h Tanh layer \endlink
 *
 * AVR controller specific implementation of the Tanh layer in \link aimath_q7.h Q7 \endlink data-type.
...
#ifndef AILAYER_TANH_AVR_PGM_H
#define AILAYER_TANH_AVR_PGM_H

#include "basic/default/ailayer/ailayer_tanh_default.h"
#include "basic/avr_pgm/aimath/aimath_q7_avr_pgm.h"


#define ailayer_tanh_f32_avr_pgm     ailayer_tanh_f32_default

/** @brief Initializes and connect a \link ailayer_tanh.h Tanh layer \endlink with the \link aimath_q7.h Q7 \endlink AVR PGM implementation
 *
 * The quantization parameters of the result tensor of the input layer must be defined constant in program memory (PROGMEM).
 * The layer configuration is the same as with ailayer_tanh_q7_default().
 *
